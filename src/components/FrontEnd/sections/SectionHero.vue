<template>
    <div class="relative">
        ...
        <svg data-v-68276cea="" width="100" height="100" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg"
            class="absolute pointer-events-none top-52 left-10">
        ...
        <svg data-v-68276cea="" width="82" height="122" viewBox="0 0 41 61" fill="none" xmlns="http://www.w3.org/2000/svg"
            class="absolute pointer-events-none top-2/4 right-0">
        ...
        <svg data-v-68276cea="" width="82" height="122" viewBox="0 0 41 61" fill="none" xmlns="http://www.w3.org/2000/svg"
            class="absolute pointer-events-none bottom-0 -left-4">
            <g data-v-68276cea="" clip-path="url(#clip0_8_176)">
                <path data-v-68276cea="" d="M3.19199 0.00012207H2.20508V0.987033H3.19199V0.00012207Z" fill="#2449DB"></path>
                <path data-v-68276cea="" d="M3.19199 5.96451H2.20508V6.95142H3.19199V5.96451Z" fill="#2449DB"></path>
                <path data-v-68276cea="" d="M3.19199 11.9335H2.20508V12.9204H3.19199V11.9335Z" fill="#2449DB"></path>
        ...
        <div class="container  md:mt-4">
            ...
            <div class="relative z-10">
                <div v-if="is_loading_carousels" class="h-[20rem] md:h-[30rem] lg:h-[40rem]">
                ...
                <div v-else >
                    <span @click="splide.go('-1')"
                        class="absolute -left-4 top-2/4 z-20 text-2xl md:text-3xl lg:text-5xl text-primary cursor-pointer">
                        <i class="fa-solid fa-chevron-left"></i>
                    </span>
                    <span @click="splide.go('+1')"
                        class="absolute -right-4 top-2/4 z-20 text-2xl md:text-3xl lg:text-5xl text-primary cursor-pointer">
                    ...
                    <div class="w-full relative rounded-lg overflow-hidden ">
                        ...
                        }" aria-label="Site Carousel">
                            <SplideSlide v-for="(item, index) in carousels">
                                <div class="h-[20rem] md:h-[30rem] lg:h-[40rem] bg-primary-50">
                                    <img :src="item.img_thumb" :alt="item.img_thumb" class="w-full h-full object-cover">
                                </div>
                            </SplideSlide>
                        </Splide>
                    </div>
...
const { carousels, is_loading_carousels, has_reached_max, load_more } = storeToRefs(carouselStore)
const { getCarousels } = carouselStore
